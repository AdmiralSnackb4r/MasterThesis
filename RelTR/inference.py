...
def get_args_parser():
    ...
    # image path
    parser.add_argument('--img_path', type=str, default='demo/vg2.jpg',
    ...
    parser.add_argument('--resume', default='ckpt/pretrained_reltr/checkpoint0149.pth', help='resume from checkpoint')
