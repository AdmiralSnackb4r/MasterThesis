...
class RelTR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        # print("ALL OBJECTS TOGETHER:")
        # print("Shape:", hs.shape)  # or tensor.size()
        # print("Data type:", hs.dtype)
        # print("Number of elements:", hs.numel())  # Total number of elements
        # print("Dimensions:", hs.dim())  # Number of dimensions
        # print("Requires Grad:", hs.requires_grad)  # Whether it tracks gradients
        # print("Mean:", hs.mean().item())
        # print("Standard Deviation:", hs.std().item())
        # print("Min:", hs.min().item())
        # print("Max:", hs.max().item())
        ...
        # print("SUBJECTS TOGETHER:")
        # print("Shape:", hs_sub.shape)  # or tensor.size()
        # print("Data type:", hs_sub.dtype)
        # print("Number of elements:", hs_sub.numel())  # Total number of elements
        # print("Dimensions:", hs_sub.dim())  # Number of dimensions
        # print("Requires Grad:", hs_sub.requires_grad)  # Whether it tracks gradients
        # print("Mean:", hs_sub.mean().item())
        # print("Standard Deviation:", hs_sub.std().item())
        # print("Min:", hs_sub.min().item())
        # print("Max:", hs_sub.max().item())

        # print("OBJECTS TOGETHER:")
        # print("Shape:", hs_obj.shape)  # or tensor.size()
        # print("Data type:", hs_obj.dtype)
        # print("Number of elements:", hs_obj.numel())  # Total number of elements
        # print("Dimensions:", hs_obj.dim())  # Number of dimensions
        # print("Requires Grad:", hs_obj.requires_grad)  # Whether it tracks gradients
        # print("Mean:", hs_obj.mean().item())
        # print("Standard Deviation:", hs_obj.std().item())
        # print("Min:", hs_obj.min().item())
        # print("Max:", hs_obj.max().item())
...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        idx_entity = self._get_src_permutation_idx(indices[0])
    ...
    def loss_relations(self, outputs, targets, indices, num_boxes, log=True):
        ...
        # Build the full target tensor filled with background class
        ...
        if log:
            rel_error = 100 - accuracy(src_logits[idx], target_classes_o)[0]
    ...
    def forward(self, outputs, targets):
        ...
        for t in targets:
            ...
            # Only count rel_annotations if they contain at least one valid (non-placeholder) entry
            if (
                "rel_annotations" in t
                and t["rel_annotations"].numel() > 0
