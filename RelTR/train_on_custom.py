...
from datasets import build_dataset, build_custom_dataset, get_coco_api_from_dataset
from master.RelTR.pre_engine import evaluate, train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--num_entities', default=6, type=int, # 100
    ...
    parser.add_argument('--img_folder', default='data/custom/images/', type=str)
...
def main(args):
    ...
    dataset_train = build_custom_dataset(image_set='train', args=args)
    dataset_val = build_custom_dataset(image_set='train', args=args)
